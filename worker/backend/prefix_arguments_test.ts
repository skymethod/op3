...
Deno.test({
    ...
    fn: () => {
        ...
        assertEquals(tryParsePrefixArguments('https://prefix-a.com/example.com/e,pg=9d99bc2b-5aa3-4a24-b43f-b6b25f63d274,hls=1,s=79683a0e97c847e8bd801de49e0b17ce/a.com/ep.mp3', opts), { pg: '9d99bc2b-5aa3-4a24-b43f-b6b25f63d274', hls: '1', s: '79683a0e97c847e8bd801de49e0b17ce' });
