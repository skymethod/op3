...
import { Bytes } from 'https://raw.denoflare.dev/skymethod/denoflare/674af1a29c14ad9fae49f0839891de97fafee5f0/common/bytes.ts';
import type { GetObjectOpts, HeadObjectOpts } from 'https://raw.denoflare.dev/skymethod/denoflare/674af1a29c14ad9fae49f0839891de97fafee5f0/common/r2/get_head_object.ts';
import type { PutObjectOpts } from 'https://raw.denoflare.dev/skymethod/denoflare/674af1a29c14ad9fae49f0839891de97fafee5f0/common/r2/put_object.ts';
import type { AwsCallContext, CompletedPart } from 'https://raw.denoflare.dev/skymethod/denoflare/674af1a29c14ad9fae49f0839891de97fafee5f0/common/r2/r2.ts';
import type { ListBucketResult, ListObjectsOpts } from 'https://raw.denoflare.dev/skymethod/denoflare/674af1a29c14ad9fae49f0839891de97fafee5f0/common/r2/list_objects_v2.ts';
import type { UploadPartOpts } from 'https://raw.denoflare.dev/skymethod/denoflare/674af1a29c14ad9fae49f0839891de97fafee5f0/common/r2/upload_part.ts';
import { abortMultipartUpload, completeMultipartUpload, createMultipartUpload, deleteObject, getObject, headObject, listObjectsV2, putObject, uploadPart } from 'https://raw.denoflare.dev/skymethod/denoflare/674af1a29c14ad9fae49f0839891de97fafee5f0/common/r2/r2.ts';
