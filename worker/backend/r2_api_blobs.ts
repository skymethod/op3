...
import { Bytes } from 'https://raw.githubusercontent.com/skymethod/denoflare/75ac0717ec34f1ed500c3605ef068394646a7486/common/bytes.ts';
import type { GetObjectOpts, HeadObjectOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/75ac0717ec34f1ed500c3605ef068394646a7486/common/r2/get_head_object.ts';
import type { PutObjectOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/75ac0717ec34f1ed500c3605ef068394646a7486/common/r2/put_object.ts';
import type { AwsCallContext, CompletedPart } from 'https://raw.githubusercontent.com/skymethod/denoflare/75ac0717ec34f1ed500c3605ef068394646a7486/common/r2/r2.ts';
import type { ListBucketResult, ListObjectsOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/75ac0717ec34f1ed500c3605ef068394646a7486/common/r2/list_objects_v2.ts';
import type { UploadPartOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/75ac0717ec34f1ed500c3605ef068394646a7486/common/r2/upload_part.ts';
import { abortMultipartUpload, completeMultipartUpload, createMultipartUpload, deleteObject, getObject, headObject, listObjectsV2, putObject, uploadPart } from 'https://raw.githubusercontent.com/skymethod/denoflare/75ac0717ec34f1ed500c3605ef068394646a7486/common/r2/r2.ts';
