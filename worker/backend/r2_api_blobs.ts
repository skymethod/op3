...
import { Bytes } from 'https://raw.githubusercontent.com/skymethod/denoflare/0e88d26ccc67a355fbb27397b7a3c9266c207e80/common/bytes.ts';
import type { GetObjectOpts, HeadObjectOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/0e88d26ccc67a355fbb27397b7a3c9266c207e80/common/r2/get_head_object.ts';
import type { PutObjectOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/0e88d26ccc67a355fbb27397b7a3c9266c207e80/common/r2/put_object.ts';
import type { AwsCallContext, CompletedPart } from 'https://raw.githubusercontent.com/skymethod/denoflare/0e88d26ccc67a355fbb27397b7a3c9266c207e80/common/r2/r2.ts';
import type { ListBucketResult, ListObjectsOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/0e88d26ccc67a355fbb27397b7a3c9266c207e80/common/r2/list_objects_v2.ts';
import type { UploadPartOpts } from 'https://raw.githubusercontent.com/skymethod/denoflare/0e88d26ccc67a355fbb27397b7a3c9266c207e80/common/r2/upload_part.ts';
import { abortMultipartUpload, completeMultipartUpload, createMultipartUpload, deleteObject, getObject, headObject, listObjectsV2, putObject, uploadPart } from 'https://raw.githubusercontent.com/skymethod/denoflare/0e88d26ccc67a355fbb27397b7a3c9266c207e80/common/r2/r2.ts';
