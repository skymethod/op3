...
const COSTS: Cost[] = [
    {
        ...
        detail: [
            ...
            { description: 'Workers requests', cost: 30.14 },
            { description: 'Durable Objects Compute', cost: 4.05 },
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 433.80 },
            { description: 'Durable Objects Storage', cost: 39.00 },
            { description: 'R2 Data Storage', cost: 68.43 },
            { description: 'R2 Storage Operations', cost: 51.12 },
            { description: 'Queues Operations', cost: 90.00 },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 },
            { description: 'Workers requests', cost: 50.54 },
            { description: 'Durable Objects Compute', cost: 11.70 },
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 526.80 },
            { description: 'Durable Objects Storage', cost: 43.20 },
            { description: 'R2 Data Storage', cost: 65.31 },
            { description: 'R2 Storage Operations', cost: 55.98 },
            { description: 'Queues Operations', cost: 97.60 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 },
            { description: 'Workers requests', cost: 44.06 },
            { description: 'Durable Objects Compute', cost: 9.15 },
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 473.6 },
            { description: 'Durable Objects Storage', cost: 41 },
            { description: 'R2 Data Storage', cost: 60.29 },
            { description: 'R2 Storage Operations', cost: 51.48 },
            { description: 'Queues Operations', cost: 94.80 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 },
            { description: 'Workers requests', cost: 39.98 },
            { description: 'Durable Objects Compute', cost: 8.40 },
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 423.80 },
            { description: 'Durable Objects Storage', cost: 39.40 },
            { description: 'R2 Data Storage', cost: 59.43 },
            { description: 'R2 Storage Operations', cost: 56.70 },
            { description: 'Queues Operations', cost: 87.60 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 }, 
            { description: 'Workers requests', cost: 26.94 },
            { description: 'Durable Objects Compute', cost: 0.00 }, 
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 364.80 },
            { description: 'Durable Objects Storage', cost: 35.20 },
            { description: 'R2 Data Storage', cost: 54.80 },
            { description: 'R2 Storage Operations', cost: 51.84 },
            { description: 'Queues Operations', cost: 74.40 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 },
            { description: 'Workers requests', cost: 21.53 },
            { description: 'Durable Objects Compute', cost: 0.00 }, 
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 358.40 },
            { description: 'Durable Objects Storage', cost: 33.60 },
            { description: 'R2 Data Storage', cost: 52.14 },
            { description: 'R2 Storage Operations', cost: 51.12 },
            { description: 'Queues Operations', cost: 78.40 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 },
            { description: 'Workers requests', cost: 16.84 },
            { description: 'Durable Objects Compute', cost: 0.00 },
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 316.20 },
            { description: 'Durable Objects Storage', cost: 29.80 },
            { description: 'R2 Data Storage', cost: 46.44 },
            { description: 'R2 Storage Operations', cost: 45.54 },
            { description: 'Queues Operations', cost: 63.20 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 },
            { description: 'Workers requests', cost: 17.10 },
            { description: 'Durable Objects Compute', cost: 0.60 },
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 344.40 },
            { description: 'Durable Objects Storage', cost: 33.20 },
            { description: 'R2 Data Storage', cost: 49.20 },
            { description: 'R2 Storage Operations', cost: 30.60 },
            { description: 'Queues Operations', cost: 64.80 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
    ...
    },
    {
        ...
        detail: [
            { description: 'Workers Paid Subscription', cost: 5.00 },
            { description: 'Workers requests', cost: 16.54 },
            { description: 'Durable Objects Compute', cost: 0.75 },
            { description: 'Durable Objects Reads/Writes/Deletes', cost: 328.60 },
            { description: 'Durable Objects Storage', cost: 33.60 },
            { description: 'R2 Data Storage', cost: 46.97 },
            { description: 'R2 Storage Operations', cost: 46.62 },
            { description: 'Queues Operations', cost: 63.60 },
            { description: 'Advanced Certificate Manager (op3.st)', cost: 10.00 },
            { description: 'Cloudflare Pro Plan (op3.dev)', cost: 25.00 },
        ]
    },
