...
Deno.test({
    ...
    fn: () => {
        ...
        assertEquals(computeListenerIpAddress({ rawIpAddress: '1.2.3.4', xForwardedFor: '2.3.4.5', asn: undefined, userAgent: 'Mozilla/5.0 (Cloud Phone; Nokia 110 4G)' }), { listenerIpAddress: '1.2.3.4', usedXForwardedFor: false });
        assertEquals(computeListenerIpAddress({ rawIpAddress: '1.2.3.4', xForwardedFor: '2.3.4.5', asn: 123, userAgent: 'Mozilla/5.0 (Cloud Phone; Nokia 110 4G)' }), { listenerIpAddress: '1.2.3.4', usedXForwardedFor: false });
        assertEquals(computeListenerIpAddress({ rawIpAddress: '1.2.3.4', xForwardedFor: '2.3.4.5', asn: 174, userAgent: 'Mozilla/5.0 (Cloud Phone; Nokia 110 4G)' }), { listenerIpAddress: '2.3.4.5', usedXForwardedFor: true });
        assertEquals(computeListenerIpAddress({ rawIpAddress: '1.2.3.4', xForwardedFor: '2.3.4.5', asn: 174, userAgent: 'Mozilla/5.0 (Nokia 110 4G)' }), { listenerIpAddress: '1.2.3.4', usedXForwardedFor: false });
    }
});