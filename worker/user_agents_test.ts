...
const botTests = {
    ...
    'Mozilla/5.0 AccountingPodcastDownloader/1.0': { type: 'bot', name: `AccountingPodcastDownloader` },
    ...
    'atlas-transcribe/1.0': { type: 'bot', name: `atlas-transcribe` },
    ...
    'audio-sanity-check/1.0': { type: 'bot', name: `audio-sanity-check` },
    ...
    'beehiiv-podcast-importer/1.0': { type: 'bot', name: `Beehiiv podcast importer` },
    ...
    'ConduitMCP/1.0 (+Lab36)': { type: 'bot', name: `ConduitMCP` },
    ...
    'DutchPodcastScraper/1.0 (research; episode audio collection)': { type: 'bot', name: `DutchPodcastScraper` },
    ...
    'MagellanAI/1.0.4285': { type: 'bot', name: `MagellanAI` },
    ...
    'PodcastIndex Classifier/1.0': { type: 'bot', name: `Podcastindex.org` },
    ...
    'PodcastDL/1.0 (+https://github.com/podcast-dl)': { type: 'bot', name: `PodcastDL` },
    'podcastdl/1.0 (+https://github.com/)': { type: 'bot', name: `PodcastDL` },
    ...
    'podcast-download-worker/1.0': { type: 'bot', name: `podcast-download-worker` },
    'podcast-grabber/0.1.0': { type: 'bot', name: `podcast-grabber` },
    'PodcastPipeline/1.0': { type: 'bot', name: `PodcastPipeline` },
    'podcast-preflight/1.0': { type: 'bot', name: `podcast-preflight` },
    ...
    'Mozilla/5.0 pods3-backfill/1.0': { type: 'bot', name: `pods3-backfill` },
    ...
    'Mozilla/5.0 (compatible; PodSearcher/1.0; +https://podsearcher.com)': { type: 'bot', name: `PodSearcher` },
    'PodSearcher/1.0': { type: 'bot', name: `PodSearcher` },
    ...
    'Mozilla/5.0 (compatible; public-episode-downloader/1.0)': { type: 'bot', name: `public-episode-downloader` },
    ...
    'Mozilla/5.0 (Reference Finder Podcast Downloader)': { type: 'bot', name: `Reference Finder Podcast Downloader` },
    ...
    'vercel-image-optimization/1.0': { type: 'bot', name: `Vercel image optimization` },
    ...
    'Mozilla/5.0 (compatible; WhisperProxy/1.0)': { type: 'bot', name: `WhisperProxy` },
...
const appTests = {
    ...
    'ARD Sounds/4.0.0 (Google Play) Dalvik/2.1.0 (Linux; U; Android 16; 2410CRP4CG Build/BP2A.250605.031.A3)': { type: 'app', name: `ARD Sounds` },
    'ARD Sounds/4.0.0 (iOS) Mozilla/5.0 (iPhone; CPU iPhone OS 18_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148': { type: 'app', name: `ARD Sounds` },
