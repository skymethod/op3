...
Deno.test({
    ...
    fn: () => {
        ...
        assertEquals(computeChainEstimate('https://pdrl.fm/r/86c73b/6f0827/a.com/path/to/episode.mp3'), [
        ...
        assertEquals(computeChainEstimate('https://swap.fm/track/12345ABCDEabcde12345/a.com/path/to/episode.mp3'), [
        ...
        assertEquals(computeChainEstimate('https://pp.example.com/protect/example/a.com/path/to/episode.mp3'), [
        ...
        assertEquals(computeChainEstimate('https://op3.dev/e/pg=bbda7016-db7b-4e3d-8bee-22c14bb71457/a.com/path/to/episode.mp3'), [
            { kind: 'prefix', prefix: 'op3', url: 'https://op3.dev/e/pg=bbda7016-db7b-4e3d-8bee-22c14bb71457/a.com/path/to/episode.mp3' },
            { kind: 'destination', url: 'https://a.com/path/to/episode.mp3' }
        ]);

        assertEquals(computeChainEstimate('https://op3.dev/e/pg=bbda7016-db7b-4e3d-8bee-22c14bb71457,hls=1/a.com/path/to/episode.mp3'), [
