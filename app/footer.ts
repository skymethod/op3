...
type Opts = { mostRecentDate: string | undefined, strings: Record<string, string> };

export const makeFooter = ({ mostRecentDate = new Date().toISOString().substring(0, 10), strings }: Opts) => {
